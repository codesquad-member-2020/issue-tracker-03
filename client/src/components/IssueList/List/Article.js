...
const OpenIcon = () => {
  return (
    <IssueIcon viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true" bgColor="#28a745">
...
const CloseIcon = () => {
  return (
    <IssueIcon viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true" bgColor="#cb2431">
...
const Article = ({ data, onCheckboxClick, checked }) => {
  const { id, title, author, labels, mileStone, createdTimeAt, assignee, commentCount, isOpen } = data;
  ...
  return (
    <ArticleWrap>
      ...
      <ArticleCol styleProps="widthAuto">{isOpen ? <OpenIcon /> : <CloseIcon />}</ArticleCol>
      <ArticleCol styleProps="flexAuto">
        ...
        <IssueDescription>
          ...
          {mileStone && (
            <span>
              <svg viewBox="0 0 16 16" version="1.1" width="16" height="16" role="img">
